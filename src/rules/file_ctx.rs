...
impl FileCtx {
    ...
    pub fn build(path: &Path, source: &str, language: Language, project: &ProjectCtx) -> Self {
        ...
        let is_generated = is_generated_content(source)
            ...
            || crate::rules::path_utils::is_build_artifact_path(path);
...
/// / `automatically generated` / `code generated` banner, a
/// `This file has been generated by <tool>` banner (hand-rolled codegen
/// scripts and rust-bindgen-style output), a fiat-crypto-style
/// `//! Autogenerated:` banner, or an AutoRest-style
...
pub(crate) fn is_generated_content(source: &str) -> bool {
    ...
    for line in head.lines().take(30) {
        ...
        // A "This file has been/was generated by <tool>" banner — the header
        // shape emitted by hand-rolled codegen scripts (e.g. zstd-rs's
        // `./update_consts.sh`) and many tools that don't carry a `@generated`
        // / `do not edit` marker. Anchored on a leading "this file" so prose
        // like "the spec was generated by openapi-typescript" cannot match.
        let lower_inner = inner.to_ascii_lowercase();
        if lower_inner.starts_with("this file") && lower_inner.contains("generated by") {
            return true;
        }
        // fiat-crypto (and other Rust code generators) head their output with a
        // banner whose first comment line is `//! Autogenerated: <tool> ...`
        // (a Rust inner doc-comment). The one-word `Autogenerated` immediately
        // followed by `:` is a tool banner, not prose, so anchor on that prefix
        // — `lower.contains("auto-generated")` above only catches the hyphenated
        // form. The leading `!` is the inner-doc-comment marker.
        let banner = inner.trim_start_matches('!').trim_start();
        if banner.to_ascii_lowercase().starts_with("autogenerated:") {
            return true;
        }
...
mod tests {
    ...
    #[test]
    fn fiat_crypto_autogenerated_header_is_generated_issue4844() {
        // Issue #4844: fiat-crypto heads its verified field-arithmetic Rust
        // output with `//! Autogenerated: fiat-crypto ...` and no
        // `@generated` / `do not edit` marker. The one-word `Autogenerated:`
        // banner must mark the whole file generated so no rule runs on it.
        let src = "//! Autogenerated: fiat-crypto unsaturated-solinas --lang Rust --inline p521 64 '(auto)' '2^521 - 1' carry_add\n//! curve description: p521\n//! machine_wordsize = 64\n\npub fn add(x: u64) -> u32 { x as u32 }\n";
        assert!(is_generated_content(src));
    }

    #[test]
    fn fiat_crypto_autogenerated_header_sets_is_generated_issue4844() {
        let project = ProjectCtx::empty();
        let generated = FileCtx::build(
            Path::new("p521/src/arithmetic/field/p521_64.rs"),
            "//! Autogenerated: fiat-crypto unsaturated-solinas --lang Rust\n\npub fn cast(x: u64) -> u32 { x as u32 }\n",
            Language::Rust,
            &project,
        );
        assert!(generated.is_generated);
        // A hand-written Rust file with the same kind of `as` cast is still
        // linted — only the explicit autogenerated banner exempts the file.
        let hand = FileCtx::build(
            Path::new("p521/src/arithmetic/field/helpers.rs"),
            "pub fn cast(x: u64) -> u32 { x as u32 }\n",
            Language::Rust,
            &project,
        );
    ...
    #[test]
    fn rust_bindgen_header_sets_is_generated_issue5321() {
        // Issue #5321: rust-bindgen heads its FFI bindings with
        // `/* automatically generated by rust-bindgen <version> */`. The C ABI
        // dictates the constant names (e.g. `ZSTD_seekTableFooterSize`), so the
        // whole file must be exempt — no rule runs on machine-generated bindings.
        let project = ProjectCtx::empty();
        let bindings = FileCtx::build(
            Path::new("zstd-sys/src/bindings_zstd_seekable.rs"),
            "/* automatically generated by rust-bindgen 0.71.1 */\n\npub const ZSTD_seekTableFooterSize: u32 = 9;\n",
            Language::Rust,
            &project,
        );
        assert!(bindings.is_generated);
    }

    #[test]
    fn this_file_has_been_generated_banner_sets_is_generated_issue5321() {
        // Issue #5321: zstd-rs's `./update_consts.sh` heads its output with
        // `// This file has been generated by ./update_consts.sh`. The names
        // mirror the upstream C API verbatim, so the file must be exempt.
        let project = ProjectCtx::empty();
        let generated = FileCtx::build(
            Path::new("zstd-safe/src/constants_seekable.rs"),
            "// This file has been generated by ./update_consts.sh\npub const seekTableFooterSize: u32 = zstd_sys::ZSTD_seekTableFooterSize;\n",
            Language::Rust,
            &project,
        );
        assert!(generated.is_generated);
        // A hand-written Rust file with the SAME non-SCREAMING_SNAKE constant
        // (no generated banner) is still linted — only the banner exempts it.
        let hand = FileCtx::build(
            Path::new("zstd-safe/src/constants_seekable.rs"),
            "pub const seekTableFooterSize: u32 = 9;\n",
            Language::Rust,
            &project,
        );
        assert!(!hand.is_generated);
    ...
    #[test]
    fn this_file_was_generated_banner_is_generated_issue5321() {
        // The "was generated by" phrasing variant of the same header shape.
        assert!(is_generated_content(
            "// This file was generated by a code generator. Do not modify by editing.\npub const fooBar: u32 = 1;\n"
        ));
    }

    #[test]
    fn prose_mentioning_generated_by_is_not_generated_issue5321() {
        // A hand-written comment mentioning "generated by" mid-prose, not
        // anchored on a leading "this file", must stay non-generated.
        assert!(!is_generated_content(
            "// The token below was generated by a teammate for local testing.\npub const fooBar: u32 = 1;\n"
        ));
    }

    #[test]
    fn incidental_autogenerated_mention_is_not_generated_issue4844() {
        // A hand-written comment that merely mentions "autogenerated" mid-prose
        // (no leading `Autogenerated:` banner) must stay non-generated.
        assert!(!is_generated_content(
            "// The fixtures below were autogenerated once and then edited by hand.\npub const N: u32 = 1;\n"
        ));
    }
    ...
    #[test]
    fn content_hash_bundle_sets_is_generated_issue5419() {
        let project = ProjectCtx::empty();
        // The issue's reproducer: a content-hash-named Vite bundle checked in
        // under a `public/.../assets/` directory. Recognized as generated by name
        // + location alone, so the engine gate skips it for every rule even if its
        // content shape did not trip the minified heuristic.
        let bundle = FileCtx::build(
            Path::new("website/public/demos/territory-wars/assets/index-CJXmzTYg.js"),
            "const x = (a, b) => (a, b);\n",
            Language::JavaScript,
            &project,
        );
        assert!(bundle.is_generated);
        // A hand-written, non-hash file in the same `public/` tree is still
        // analysed: it carries no content-hash suffix.
        let hand = FileCtx::build(
            Path::new("website/public/widget.js"),
            "const x = (a, b) => (a, b);\n",
            Language::JavaScript,
            &project,
        );
        assert!(!hand.is_generated);
        // Genuine source under `src/` is analysed even if hash-shaped: no
        // build-output segment.
        let src = FileCtx::build(
