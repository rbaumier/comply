//! tailwind-no-important-modifier oxc backend for TS / JS / TSX.
...
impl OxcCheck for Check {
    ...
    fn run<'a>(
        ...
        if !super::has_important_class(class_str) {
            return;
        }
...
mod tests {
    ...
    fn flags_important_class() {
        assert_eq!(run(r#"const x = <div className="!text-red-500 flex" />;"#).len(), 1);
    }

    #[test]
    fn flags_important_in_middle() {
        assert_eq!(run(r#"const x = <div className="w-full !hidden" />;"#).len(), 1);
    }
